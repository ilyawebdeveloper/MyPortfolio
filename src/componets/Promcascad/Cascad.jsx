  ...
  return (
		<>
			...
			<div className='menu'>
				<div className='containerCascad'>
					<div className='navCascad'>
						<a className='nav__linkCascad1' href='/'>
							ЛИНЕЙКА "CATHERINE"
						</a>
						<a className='nav__linkCascad' href='/'>
							ПРОИЗВОДСТВО
						</a>
						<a className='nav__linkCascad' href='/'>
							ГАЛЕРЕЯ
				...
				<div className='containerCascad'>
					...
					<div className='performance'>
						...
						<ul className='performance__list'>
							...
							<li className='performance__one'>
								Разнообразие длин: 1.0 м, 1,5 м, 2.0 м, 2,5 м (+ под заказ);
							</li>
							<li className='performance__one'>
								Спец фурнитура. В том числе, по запроса.
							</li>
						</ul>
					</div>
				</div>
				...
				<div className='containerCascad'>
					<div className='galary__flex'>
						<div className='galary__title'>
							<div className='galary__img'>
								<img src={photo2} alt='' />
							</div>
							<div className='galary__text'>
								Защита пальцев от <br />
								случайных травм. Удобство при работе
							</div>
						</div>
						...
						<div className='galary__title'>
							...
							<div className='galary__text'>
								Нержавеющая полоса сохранить кромку при работе с острым лезвием
							</div>
						</div>
						...
						<div className='galary__title'>
							...
							<div className='galary__text'>
								Полоса прижата к рабочей поверхности это залог точный реза{' '}
							</div>
						</div>
			...
			<div className='product'>
				<div className='containerCascad'>
					<div className='product__flex'>
						<h1 className='product__title'>О ПРОИЗВОДИТЕЛЕ</h1>
						<div className='border__3'></div>
					</div>

					<div className='product__text'>
						<h2 className='product__title2'>
							Компания «Промкаскад» производит разнообразную продукцию уже более
							10 лет.
							<br /> Штамповка, металлообоработка, оборудование под заказ — это
							то, чем мы живем <br />
							каждый день. Среди наших изделий есть новации, ставшие популярными
							в РФ и за <br />
							рубежом.
							<br />
							Алюминиевая линейка «Кэтрина» пример подобных новинок, ее давно
							просили <br />
							багетные мастерские и магазины с листовыми и рулонными
							материалами. <br />
							Мы будем рады замечаниями и предложениям.{' '}
						</h2>
						...
						<div className='product__logo'>
							...
							<button className='product__button'>
								{' '}
								<a href='/' className='btn__product'>
									{' '}
									Звоните! 8 800 333-17-13{' '}
								</a>
							</button>
						</div>
					</div>
			...
			<div className='slaider'>
				<div className='containerCascad'>
					<div className='slaider__title'>
						ГАЛЕРЕЯ ИЗОБРАЖЕНИЙ ИСПОЛЬЗОВАНИЯ
					</div>
					<div className='slaider__img'>
						<img src={c1} alt='not found' />
					</div>
					<div className='slaider__text'>
						ОТЗЫВЫ ПРОФЕССИОНАЛЬНЫХ ПОЛЬЗОВАТЕЛЕЙ
					</div>
				...
				<div className='containerCascad'>
					<div className='skill__box'>
						<div className='skill__text'>
							Усильте свой набор профессиональных инструментов
						</div>
						<div className='skill__border'></div>
					</div>

					<div className='skill__ex'>
						Работаем оптом и в розницу
						<br />
						Цена включает НДС
						<br />
				...
				<div className='containerCascad'>
					...
					<div className='contact__flex'>
						<div className='contact__text'>
							Линейка «Catherine» защищена авторским патентом РФ.
							<br />
							Контактная информация для общения отделом продаж ООО <br />
							«Промкаскад»
							<div className='contact__ulli'>
								<ul className='contact__ul'>
									<li className='contact__li'>
										г. Челябинск ул. Рождественского 13/1 (вход через <br />
										проходную ЧАМЗ), оф. 411-414 (4 этаж)
									</li>
									...
									<li className='contact__li'>
										...
										Время работы склада: 9:00-16:00
									</li>
				...
				<div className='containerCascad'>
					<div className='footer__iner'>
						<div className='footer__flex'>
							...
							<a href='/' className='footer_number'>
								8 800 333-14-13
							</a>
						...
						<div className='footer__flex'>
							...
							<div className='footer__titletoo'>
								<a href='/' className='footer__nav'>
									ЛИНЕЙКА "CATHERINE"{' '}
								</a>
							</div>
							<div className='footer__titletoo'>
