      ...
      <header className="headerMon"> 
           <div className="containerMon">
                <div className= "header__iner">
                    ...
                    <nav className="nav">
                        ...
                        <a className="nav__link" href="/">Акции</a>
            ...
            <div className="intro">
                <div className="containerMon">
                        <div className="intro__iner">
                            ...
                            <a className="btn btn--blue" href="/">Регистрация</a>
                        </div>
                </div>
            </div>
        ...
        <div className="containerMon">
            <div className="features">
                    <div className="features__item">
                        ...
                        <div className="feature__text">лучшие специалисты по маникюру в росии с оптытом работы более 3-ех лет</div>
                    </div>
        ...
        <div className="team">
            <div className="containerMon">
                <div className="team__iner">
                    ...
                    <div className="team__item">
                        ...
                        <div className="team__text">Гинеколог занимается наблюдением, диагностикой, лечением и профилактикой заболеваний репродуктивной системы женского организма.</div>
                    </div>
                    ...
                    <div className="team__item">
                        ...
                        <div className="team__text">Терапевт – врач широкого профиля, компетентный во всех заболеваниях взрослого человека.</div>
                    </div>
                    ...
                    <div className="team__item">
                        ...
                        <div className="team__text">ЛОР – врач «ухо-горло-нос», занимающийся диагностикой и лечением болезней данных органов и связанных с ними структур шеи и головы.</div>
                    </div>
                ...
                <div className="containerMon">
                    ...
                    <div className="previu__item">
                        ...
                        <div className="previu__content">
                            <h3 className="previu__text">Как я избавлялась от боли получив побочки или Применение дексаметазона возможно в том случае, если польза для организма превышает риск развития побочных эффектов от самого дексаметазона</h3>
            ...
            <div className="registr">
                <div className="containerMon">
                    <h3 className="registr__title"> Регистрация
                        <div className="registr__text"> <p>Узнать подробнее о наших услугах вы можете нажав кнопку 
                         Регистрация</p>
                        </div>
                        <a className="btn btn--long btn--blue" href="/">Регистрация</a>
                    </h3>
                </div>
            </div>
                ...
                <div className="containerMon">
                    ...
                    <div className="footer__iner">
                        <div className="footer__blok">
                            <div className="footer__text">Создатель:
